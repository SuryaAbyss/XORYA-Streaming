...
export const LiquidGlassViewport = React.forwardRef<HTMLDivElement, LiquidGlassViewportProps>(
    ({ bgImage, fallbackMode = "webgl", className, children, ...props }, _ref) => {
        ...
        React.useEffect(() => {
            ...
            if (!bgImage) {
                detectedMode = "blur";
            } else if (isIOS || isSafariMac) {
                detectedMode = fallbackMode === "webgl" ? "webgl" : "blur";
            }
...
export const LiquidGlassButton = React.forwardRef<HTMLButtonElement, LiquidGlassButtonProps>(
    ({ className, children, showWaves = false, ...props }, ref) => {
        ...
        return (
            <button
                ref={activeRef}
                className={cn(
                    "relative select-none pointer-events-auto inline-flex items-center justify-center px-8 py-3.5 border-0 bg-transparent cursor-pointer outline-none origin-center transition-transform duration-[400ms] ease-[cubic-bezier(0.4,1.5,0.3,1)] active:scale-[0.96]",
                    className
                )}
                style={{
                    "--cos": "0",
            ...
            `
                ...
                {/* Red Wave Loader Animation (from sample.html) */}
                {showWaves && (
                  <>
                    <div
                    ...
                    >
                      <div
                        ...
                        style={{
                          ...
                          animation: "liquid-button-transform-anim 2s infinite alternate, liquid-button-opacity-anim 4s infinite",
                    ...
                    <style dangerouslySetInnerHTML={{ __html: `
                      @keyframes liquid-button-transform-anim {
                        0% { transform: translate(-55%); }
                        100% { transform: translate(55%); }
                      }
                      @keyframes liquid-button-opacity-anim {
                        0%, 100% { opacity: 0; }
                        15% { opacity: 1; }
                        65% { opacity: 0; }
                      }
