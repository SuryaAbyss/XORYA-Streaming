...
interface XoraLogoIntroProps {
  onComplete: () => void;
}

const LETTER_IDS = ["svgX1", "svgX2", "svgO", "svgR", "svgA1", "svgY", "svgA2"] as const;
...
export default function XoraLogoIntro({ onComplete }: XoraLogoIntroProps) {
  ...
  useEffect(() => {
    ...
    layoutId = requestAnimationFrame(() => {
      ...
      const letters: { el: SVGPathElement; len: number }[] = [];
      ...
      function offsetMe(timestamp: number) {
        if (cancelled) return;
  ...
  return (
    <div
      ref={containerRef}
      className="xora-logo-intro fixed inset-0 z-50 flex items-center justify-center bg-white overflow-hidden select-none transition-opacity duration-1000 ease-out animate-in fade-in"
    >
      <style
        dangerouslySetInnerHTML={{
          __html: `
        .xora-logo-intro .svg-intro-container {
            display: flex;
        ...
        .xora-logo-intro .svg-intro-container svg {
        ...
        .xora-logo-intro #svgX1,
        .xora-logo-intro #svgX2,
        .xora-logo-intro #svgO,
        .xora-logo-intro #svgR,
        .xora-logo-intro #svgA1,
        .xora-logo-intro #svgY,
        .xora-logo-intro #svgA2 {
            fill: rgba(0, 0, 0, 0);
            stroke: #000000;
            stroke-width: 10px;
        ...
        .xora-logo-intro.stroke-complete #svgX1 { animation: xora-logo-fill 2.2s cubic-bezier(0.25, 1, 0.5, 1) 0ms forwards; }
        .xora-logo-intro.stroke-complete #svgX2 { animation: xora-logo-fill 2.2s cubic-bezier(0.25, 1, 0.5, 1) 120ms forwards; }
        .xora-logo-intro.stroke-complete #svgO  { animation: xora-logo-fill 2.2s cubic-bezier(0.25, 1, 0.5, 1) 240ms forwards; }
        .xora-logo-intro.stroke-complete #svgR  { animation: xora-logo-fill 2.2s cubic-bezier(0.25, 1, 0.5, 1) 360ms forwards; }
        .xora-logo-intro.stroke-complete #svgA1 { animation: xora-logo-fill 2.2s cubic-bezier(0.25, 1, 0.5, 1) 480ms forwards; }
        .xora-logo-intro.stroke-complete #svgY  { animation: xora-logo-fill 2.2s cubic-bezier(0.25, 1, 0.5, 1) 600ms forwards; }
        .xora-logo-intro.stroke-complete #svgA2 { animation: xora-logo-fill 2.2s cubic-bezier(0.25, 1, 0.5, 1) 720ms forwards; }

        @-webkit-keyframes xora-logo-fill {
            0% { fill: rgba(0, 0, 0, 0); }
            100% { fill: rgba(0, 0, 0, 1); }
        }

        @keyframes xora-logo-fill {
            0% { fill: rgba(0, 0, 0, 0); }
            100% { fill: rgba(0, 0, 0, 1); }
        }
      `,
